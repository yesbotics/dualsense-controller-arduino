...
const static uint16_t DEFAULT_POLLING_INTERVAL = 50;
const static uint8_t DEFAULT_ANALOG_HAT_THRESHOLD = 2;
const static bool DEFAULT_CHECK_DIGITAL_BUTTONS = true;
const static bool DEFAULT_CHECK_ANALOG_BUTTONS = true;
const static bool DEFAULT_CHECK_ANALOG_HATS = true;
const static bool DEFAULT_CHECK_IMU = false;
const static bool DEFAULT_CHECK_TOUCHING = false;
const static bool DEFAULT_CHECK_ORIENTATION = false;
...
static DualSenseControllerValueItem<bool> DIGITAL_BUTTONS[] = {
        ...
        {ButtonEnum::PS,         DualSenseControllerValueId::PS,         DEFAULT_DIGITAL_BUTTON_VALUE},
